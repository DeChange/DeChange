...
const NFTsAndDAOs: React.FC = () => {
  ...
  const sections = [
    ...
    },
    {
      title: 'Practice',
      icon: play,
      completed: courseState.contextCompletedSections[3],
    },
    {
      title: 'Quiz',
      icon: question,
      completed: courseState.contextCompletedSections[4],
    },
  ]

  const handleNext = () => {
    if (courseState.currentSection < sections.length - 1) {
        ...
        <div className="flex flex-col gap-6 max-w-full overflow-hidden">
          ...
          <div className="flex mt-14 justify-between items-start self-stretch flex-grow-0 flex-shrink-0 py-4">
            <div className="flex flex-col justify-center items-start flex-grow gap-2">
              ...
              >
                {courseState.currentSection === 0 ? null : (
                  <>
                    <svg
                      width={18}
                      height={18}
                    ...
                    <button
                      ...
                      disabled={courseState.currentSection === 0}
            ...
            <div className="flex flex-col justify-center items-end flex-grow gap-2">
              ...
              >
                <button
                  ...
                  disabled={
                    rewardsClaimed ||
                    (courseState.currentSection === 4 && !allAnswersCorrect)
                  }
                  className={`flex justify-center items-center flex-grow-0 flex-shrink-0 relative gap-2 px-2 ${
                    (courseState.currentSection === 4 && !allAnswersCorrect) ||
                    rewardsClaimed
                ...
                >
                  <p className="flex-grow-0 flex-shrink-0 text-base font-medium text-left text-white">
                    {courseState.currentSection === 4 ? 'Submit' : 'Next'}
                  </p>
                </button>
                <svg
                  width={19}
