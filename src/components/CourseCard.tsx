...
const CourseCard: React.FC<CourseCardProps> = ({ title, level, slug }) => {
  return (
    <Link href={`/course/${slug}`}>
      <div className="h-[301px] w-full px-3 pt-3 pb-4 bg-white/5 rounded-3xl shadow-inner border border-[#7B51EA2E] backdrop-blur-lg flex-col justify-start items-start gap-3.5 inline-flex cursor-pointer">
